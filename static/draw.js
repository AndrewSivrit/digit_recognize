...
function positive_pred() {
	if (document.getElementById("Checkbox").checked == true) {
		...
		document.getElementById("answer_reaction").innerHTML = "Cool!";
		document.getElementById("prediction").style.display = "none";
	}
}
...
function negative_pred() {
	if (document.getElementById("Checkbox").checked == true) {
		document.getElementById("answer_reaction").innerHTML = "choose the correct number and apply";
		document.getElementById("prediction").style.display = "none";
...
function nothing() {
	document.getElementById("prediction").style.display = "none";
	document.getElementById("answer_reaction").innerHTML = "Well, I need to digit)";
}
...
function predict() {
	...
	$.ajax({
		...
		if (response == "You need to draw something") {
			document.getElementById("hide_show_btn").style.display = "none";
			document.getElementById("prediction").style.display = "none";
			document.getElementById("hidable").style.display = "none";
			document.getElementById("answer_reaction").innerHTML = "";
